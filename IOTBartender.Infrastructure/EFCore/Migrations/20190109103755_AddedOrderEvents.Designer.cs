...
namespace IOTBartender.Infrastructure.EFCore.Migrations
{
    ...
    [Migration("20190109103755_AddedOrderEvents")]
    partial class AddedOrderEvents
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOTBartender.Domain.Entititeis.OrderEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("IOTBartender.Domain.Entititeis.OrderEvent", b =>
                {
                    b.HasOne("IOTBartender.Domain.Entititeis.Order", "Order")
                        .WithMany("Events")
